        ...
        <div class="mb-6">
          <ul class="flex flex-col gap-[2px] ml-4 list-none">
            <li>
              <div class="flex flex-row gap-2">
                <span class="text-lg font-medium font-rubik">Accuracy:</span>
                <span class="self-center text-md font-normal">{{ testingResult.accuracy }}%</span>
              </div>
            </li>
            <li>
              <div class="flex flex-row gap-2">
                <span class="text-lg font-medium font-rubik">Loss:</span>
                <span class="self-center text-md font-normal">{{ testingResult.loss }}</span>
              </div>
            </li>
            <li>
              <div class="flex flex-row gap-2">
                <span class="text-lg font-medium font-rubik">Training Images:</span>
                <span class="self-center text-md font-normal">{{ testingResult.imageNum }}</span>
              </div>
            </li>
          </ul>
        </div>
